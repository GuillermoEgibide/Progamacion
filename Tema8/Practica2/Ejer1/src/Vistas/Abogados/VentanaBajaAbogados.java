 ...
 * @author 1GDAW12
 */
public class VentanaBajaAbogados extends javax.swing.JFrame {

    /**
     * Creates new form VentanaBajaAbogados
     */
    public VentanaBajaAbogados() {
        initComponents();
    ...
    private void bCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCancelarActionPerformed
        Ejer1.cerrarVentanaBajaAbogados();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaBajaAbogados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaBajaAbogados().setVisible(true);
            }
        });
    }
