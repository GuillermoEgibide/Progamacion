 ...
 */
public class Ejer2 {
    private static Estudio[] listaEstudios = new Estudio[3];
    ...
    private static void peliculaMasLarga() {
       float maximo = 0;
        ...
        JOptionPane.showMessageDialog(null," La pelicula más larga es " + objeto.getTitulo());
    }
    ...
    private static void estudioMasPeliculas() {
       ...
       JOptionPane.showMessageDialog(null, listaEstudios[posicion].getNombre() +  " ha producido mas peliculas");
    }
